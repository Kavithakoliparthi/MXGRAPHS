...
export class PortsComponent implements OnInit {
  ...
  ngOnInit()
  {
   ...
   main(container, outline, toolbar, sidebar, status)
        ...
        // Enables guides
        //mxGraphHandler constructs an event handler that creates handles for the selection
				mxGraphHandler.prototype.guidesEnabled = true;

          // Alt disables guides
          //mxGuide implements the alignment of selection cells to other cells
		    mxGuide.prototype.isEnabledForEvent = function(evt)
				...
				var config = mxUtils.load('assets/keyhandler-commons.xml').	getDocumentElement();
        ...
        this.addToolbarButton(editor, toolbar, 'groupOrUngroup', '(Un)group', './assets/group.png',true);
        ...
        this.addToolbarButton(editor, toolbar, 'delete', 'Delete', 'assets/delete2.png',true);
				
				toolbar.appendChild(spacer.cloneNode(true));
				
        this.addToolbarButton(editor, toolbar, 'cut', 'Cut', 'assets/cut.png',true);
        this.addToolbarButton(editor, toolbar, 'copy', 'Copy', 'assets/copy.png',true);
        this.addToolbarButton(editor, toolbar, 'paste', 'Paste', 'assets/paste.png',true);

				toolbar.appendChild(spacer.cloneNode(true));
				
        this.addToolbarButton(editor, toolbar, 'undo', '', 'assets/undo.png',true);
        this.addToolbarButton(editor, toolbar, 'redo', '', 'assets/redo.png',true);
				
				toolbar.appendChild(spacer.cloneNode(true));
				
        this.addToolbarButton(editor, toolbar, 'show', 'Show', 'assets/camera.png',true);
        this.addToolbarButton(editor, toolbar, 'print', 'Print', 'assets/printer.png',true);
        ...
        this.addToolbarButton(editor, toolbar, 'export', 'Export', 'assets/export1.png',true);

        
          // ---
          // Adds toolbar buttons into the status bar at the bottom
          // of the window.
          this.addToolbarButton(editor, status, 'collapseAll', 'Collapse All', 'assets/navigate_minus.png', true);
        this.addToolbarButton(editor, status, 'expandAll', 'Expand All', 'assets/navigate_plus.png', true);

				status.appendChild(spacer.cloneNode(true));
				
        this.addToolbarButton(editor, status, 'enterGroup', 'Enter', 'assets/view_next.png', true);
        this.addToolbarButton(editor, status, 'exitGroup', 'Exit', 'assets/view_previous.png', true);

				status.appendChild(spacer.cloneNode(true));

        this.addToolbarButton(editor, status, 'zoomIn', '', 'assets/zoom_in.png', true);
        this.addToolbarButton(editor, status, 'zoomOut', '', 'assets/zoom_out.png', true);
        this.addToolbarButton(editor, status, 'actualSize', '', 'assets/view_1_1.png', true);
        this.addToolbarButton(editor, status, 'fit', '', 'assets/fit_to_size.png', true);
		...
		addSidebarIcon(graph, sidebar, label, image)
		{
			...
			var funct = function(graph, evt, cell, x, y)
			{
				...
				try
				{
					...
					'port;image=assets/flash.png;align=right;imageAlign=right;spacingRight=18', true);
					port.geometry.offset = new mxPoint(-6, -8);
		
					var port = graph.insertVertex(v1, null, 'Input', 0, 0.75, 16, 16,
							'port;image=assets/check.png;align=right;imageAlign=right;spacingRight=18', true);
					port.geometry.offset = new mxPoint(-6, -4);
					
					var port = graph.insertVertex(v1, null, 'Error', 1, 0.25, 16, 16,
							'port;image=assets/error.gif;spacingLeft=18', true);
					port.geometry.offset = new mxPoint(-8, -8);

					var port = graph.insertVertex(v1, null, 'Result', 1, 0.75, 16, 16,
							'port;image=assets/information.png;spacingLeft=18', true);
